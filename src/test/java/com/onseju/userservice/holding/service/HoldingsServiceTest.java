...
class HoldingsServiceTest {
	...
	void getExistingHoldings() {
		...
		AfterTradeHoldingsDto params = new AfterTradeHoldingsDto(Type.SELL, ACCOUNT_ID, COMPANY_CODE,
				new BigDecimal(1000),
				new BigDecimal(10));
	...
	void createHoldings() {
		// given
		AfterTradeHoldingsDto params = new AfterTradeHoldingsDto(Type.BUY, ACCOUNT_ID, COMPANY_CODE,
				new BigDecimal(1000),
				new BigDecimal(10));
