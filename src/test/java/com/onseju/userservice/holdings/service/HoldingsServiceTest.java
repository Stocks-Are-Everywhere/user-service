...
class HoldingsServiceTest {
    ...
    void getExistingHoldings() {
        ...
        UpdateHoldingsDto params = new UpdateHoldingsDto(Type.SELL, ACCOUNT_ID, COMPANY_CODE, new BigDecimal(1000), new BigDecimal(10));
    ...
    void createHoldings() {
        // given
        UpdateHoldingsDto params = new UpdateHoldingsDto(Type.BUY, ACCOUNT_ID, COMPANY_CODE, new BigDecimal(1000), new BigDecimal(10));
